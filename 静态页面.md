...
```html
<font face="Arial" size="2" color="red"> text </font>
```
...
```html
<img src="https://www.freecatphotoapp.com/your-image.jpg" alt="A business cat wearing a necktie." width="100"
    height="60">
```
...
<a href="https://google.com"><img
        src="https://catchypianos.com/wp-content/uploads/2020/10/yamaha-p45-digital-piano-768x433.jpg"
        alt="A Piano." /></a>
```
...
<marquee behavior="value" bgclor="rgb" direction="value" scrollamount="value" scrolldelay="value" truespeed="truespeed"
    loop="digit" height="value" width="value" hspace="value" vspace="value">文字或图片
</marquee>
```
...
```html
<input type="submit" /> <button>Button Content</button>
```
