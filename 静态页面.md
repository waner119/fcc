...
```html
<p>空间剩余大小：
    <meter min="0" max="1024" value="600">600/1024</meter>600/1024 GB</p>
<p>得分：
    <meter min="0" max="100" low="60" high="90" optimum="100" value="91">91分</meter>91分</p>
```
...
```html
<frameset cols="value1, value2, ..."> <!-- value可以是数字px、百分比或以`*`表示的剩余值,用逗号分开，有几个值就有几个水平分割的窗口 --> 
  <frame src="URL"></frame>
  <frame src="URL"></frame>
  ...
</frameset>
...
<!-- 例子 -->
<frameset cols="200,*,*"> <!-- 第一个窗口是200，两个*代表总窗口减去200剩下的窗口尺寸平分 -->
```
